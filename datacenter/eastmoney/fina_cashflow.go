...
func (e EastMoney) QueryFinaCashflowData(ctx context.Context, secuCode string, date string) (CashflowDataList, error) {
	...
	logrus.Debug(ctx, "EastMoney QueryFinaCashflowData "+apiurl+" begin", zap.Any("params", params))
	beginTime := time.Now()

	cashflowResp := RespFinaCashflowData{}
