...
func (h GincomeDataList) FilterByReportType(reportType FinaReportType) GincomeDataList {
	...
	sort.Slice(result, func(i, j int) bool {
		return result[i].ReportDate < result[j].ReportDate
	})
...
func (e EastMoney) QueryFinaGincomeData(ctx context.Context, secuCode, date string) (GincomeDataList, error) {
	...
	respFinaGincomeData := &RespFinaGincomeData{}
	_ = json.Unmarshal(resp.Body(), respFinaGincomeData)

	return respFinaGincomeData.Result.Data, nil
}
